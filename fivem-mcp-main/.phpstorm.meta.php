...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/adrianmejias/Herd.nosync/mcp.fivem/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/adrianmejias/Herd.nosync/mcp.fivem/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'boost.executable_paths.current_directory','mcp.redirect_domains','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'boost.browser-logs','fivem','docs.index',
'docs.quickstart','docs.documentation','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'docs.documentation','docs.index','docs.quickstart','layouts.app','layouts.partials.footer',
'layouts.partials.navigation','mcp.cox.cox-event-list','mcp.cox.cox-event-reference','mcp.cox.cox-function','mcp.fivem.event-list',
'mcp.fivem.event-reference','mcp.fivem.native-function','mcp.prodigy.prodigy-event-list','mcp.prodigy.prodigy-event-reference','mcp.prodigy.prodigy-export-list',
'mcp.prodigy.prodigy-export-reference','mcp.qbcore.qbcore-config','mcp.qbcore.qbcore-event-list','mcp.qbcore.qbcore-event-reference','mcp.qbcore.qbcore-function',
'mcp.qbcore.qbcore-players','mcp.qbcore.qbcore-resource-list','mcp.qbcore.qbcore-resource-reference','mcp.qbcore.qbcore-shared-data','mcp.resources.best-practices',
'mcp.resources.code-snippets','mcp.resources.database-queries','mcp.resources.framework-comparison','mcp.shared.resource-boilerplate','mcp.shared.search-results',
'mcp.templates.client-js','mcp.templates.client-lua','mcp.templates.config-js','mcp.templates.config-lua','mcp.templates.fxmanifest',
'mcp.templates.nui-css','mcp.templates.nui-html','mcp.templates.nui-script-js','mcp.templates.nui-script-lua','mcp.templates.server-js',
'mcp.templates.server-lua','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
