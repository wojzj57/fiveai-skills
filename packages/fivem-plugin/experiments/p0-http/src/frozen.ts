/**
 * RFC-frozen contract values for the P0 host-feasibility experiment.
 *
 ...
 * proposed values). These are a P0 probe's inputs, not a published contract:
 ...
 * override from `FIVEAI_P0_HTTP_PORT` because it has no config v2 file yet —
